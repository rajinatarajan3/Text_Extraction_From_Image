...
if image is not None:
    ...
    if UP:
        if image is not None:
            ...
            sql = "INSERT INTO business_cards (website_url, email, pin_code, phone_numbers, address, card_holder_details) VALUES (%s, %s, %s, %s, %s, %s)"
...
col1.markdown("<style>div[data-testid='stHorizontalBlock'] { background-color: rgb(230, 0, 172, 0.1); }</style>",
